...
const helper = {
  ...
  operate: async (ctx) => {
    ...
    try {
      ...
      const customPrompt = `I'm Izumi, created by a developer named Irull. I can save your name ${ctx.from.first_name}, Say speak Indonesian, I'm a fun and cool bot assistant.`;
      ...
      const response = await axios.post(
        "https://bagoodex.io/front-api/chat",
        {
          ...
          messages: [
            {
              content: "Hi, this is chatgpt using model gpt-4o, I was created by someone named Irull, let's talk",
              role: "assistant",
            },
